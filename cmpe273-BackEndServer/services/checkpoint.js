...
exports.addCheckPoint = function(message, callback)
{
	...
	var addCheckPointQuery = "insert into "+TABLE_NAME+"(buidling_id,guard_id,client_id,start_latitude,end_latitude,start_longitude,end_longitude,time_from_start_to_end) "+
	" values"+
	"("+buildingId+","+guardId+","+clientId+",'"+startLatitude+"','"+endLatitude+"','"+startLongitude+"','"+endLongitude+"',"+timeFromStartToEnd+");";
...
exports.getCheckPointForBuilding = function(message,callback)
{
	...
	var getCheckPointForBuildingQuery = "select guard_id, client_id, start_latitude, end_latitude, start_longitude, end_longitude, time_from_start_to_end from "+TABLE_NAME+" "+
